...
const LABELS: Record<string, { label: string; max: number; help: string }> = {
  calorie_adherence: { label: "Calorie adherence", max: 30, help: "How close you stay to your daily calorie target without overshooting." },
  protein_adherence: { label: "Protein intake", max: 25, help: "Hitting your daily protein target — key for losing fat, not muscle." },
  water: { label: "Hydration", max: 15, help: "Aim for ~2.5 L of water per day." },
  steps: { label: "Steps", max: 15, help: "Aim for 8,000+ steps daily." },
  exercise: { label: "Exercise", max: 10, help: "Mark exercise done for a full 10 points." },
  weight_progress: { label: "Weight trend", max: 5, help: "Trending down? Full 5 points. Steady? 2 points." },
};
    ...
    <Modal visible={visible} animationType="slide" transparent onRequestClose={onClose}>
      ...
      <View style={styles.sheet}>
        ...
        <ScrollView style={{ marginTop: 12 }}>
          {Object.entries(LABELS).map(([key, { label, max, help }]) => {
